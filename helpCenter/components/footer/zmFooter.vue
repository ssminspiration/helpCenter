	 ...
	 viewBox="0 0 402.1 144.1" style="enable-background:new 0 0 402.1 144.1;" xml:space="preserve">
          ...
          <g>
            ...
            c-0.7-0.7-1.1-1.4-1.1-2.3v-0.2c0-0.9,0.4-1.6,1.1-2.3C348.1,73.8,348.9,73.4,349.9,73.4z"/>
                ...
                <div class="slogan">世界因你而不同</div>
            </div>
            <div class="zm-contact">
                <div class="left">
                    <div class="title marginBottom16">服务热线</div>
                    <p>400-820-2178</p>
                    
                    <br>
                    <div class="title marginBottom16">服务时间</div>
                    <p>每周一至周日</p>
                    <p>08:00-22:00</p>
                </div>
                <div class="right">
                    ...
                    <img src="/images/code.png" alt="族蚂二维码">
                </div>
            </div>
        </div>
        <div class="zm-link">
            <a :href="item.href" v-for="(item,index) in linkArr">{{item.name}} <span v-if="index < (linkArr.length - 1)"></span></a>
        </div>
        <div class="zm-copyright">
            <span>上海族蚂信息科技有限公司</span>
            <span>地址：上海市金山区亭林镇林盛路136号</span>
            <span>Copyright © 2017 zuma.com 版权所有</span>
            <a href="http://www.miit.gov.cn/" target="_blank">沪ICP备18007337号-2</a>
        </div>
...
export default {
    ...
    data(){
        return{
            ...
            {
              name:"帮助中心",
              href:this.wwwDomain+'/bangzhu'
            },
            {
              name:"法律声明",
              href:this.wwwDomain+'/shop_web/about_29.html'
            },
            {
              name:"隐私政策",
              href:this.wwwDomain+'/shop_web/about_30.html'
            },
            {
              name:"购物付款类型",
              href:this.wwwDomain+'/shop_web/about_2.html'
            },
            {
              name:"服务付款类型",
              href:this.wwwDomain+'/shop_web/about_8.html'
            },
            {
              name:"支付方式",
              href:this.wwwDomain+'/shop_web/about_14.html'
            },
            {
              name:"产品售后与申诉",
              href:this.wwwDomain+'/shop_web/about_18.html'
            },
            {
              name:"服务投诉与申诉",
              href:this.wwwDomain+'/shop_web/about_23.html'
            },
            {
              name:"族蚂议价流程",
              href:this.wwwDomain+'/shop_web/about_28.html'
            },
            {
              name:"关于族蚂网",
              href:this.wwwDomain+'/shop_web/about_1.html'
            },
            {
              name:"如何创建网站",
              href:this.wwwDomain+'/shop_web/about_31.html'
            },
            {
              name:"网站举报",
              href:this.wwwDomain+'/shop_web/about_32.html'
            },
            {
              name:"知识产权维权",
              href:this.wwwDomain+'/shop_web/about_35.html'
            },
          ],
        }
    },
    mounted(){
        console.log('%cfooter','font-size:32px;color:purple',this.wwwDomain,this.helpDomain)
    }
}
</script>
